...
![](reference/figures/README-example-shadow-1.png)
...
![](reference/figures/README-example-corners-1.png)
...
![](reference/figures/README-example-ellipse-1.png)

## Pick points to magnify

To choose points to magnify, map `from` in an
...
![](reference/figures/README-example-logical-from-1.png)
...
![](reference/figures/README-example-faceting-1.png)
...
![](reference/figures/README-example-outline-1.png)
...
![](reference/figures/README-example-grob-1.png)
...
![](reference/figures/README-example-axes-1.png)
...
![](reference/figures/README-example-colours-1.png)
...
![](reference/figures/README-example-proj-1.png)
...
![](reference/figures/README-example-proj-2.png)
...
![](reference/figures/README-example-proj-3.png)
...
![](reference/figures/README-example-proj-fill-1.png)
...
![](reference/figures/README-example-proj-fill-2.png)

## Tips and tricks

### Graphics devices

[`geom_magnify()`](https://hughjonesd.github.io/ggmagnify/reference/geom_magnify.md)
uses masks. This requires R version 4.1.0 or higher, and a graphics
device that supports masking. If you are using knitr, you may have luck
with the `ragg_png` device (which was used to create this README). If
your device doesn’t support masks, only `shape = "rect"` will work, and
the plot inset will not be clipped to the panel area.

### Adding layers to the inset

[`geom_magnify()`](https://hughjonesd.github.io/ggmagnify/reference/geom_magnify.md)
stores the plot when it is added to it. So, order matters:
...
![](reference/figures/README-example-order-1.png)
...
![](reference/figures/README-example-advanced-2-1.png)
...
![](reference/figures/README-example-noclip-1.png)
...
![](reference/figures/README-example-gridlines-1.png)
...
![](reference/figures/README-example-gridlines-2.png)
...
![](reference/figures/README-example-recompute-1.png)
...
![](reference/figures/README-example-recompute-2.png)
...
![](reference/figures/README-example-magnify-twice-1.png)
...
![](reference/figures/README-example-and-so-ad-infinitum-1.png)
