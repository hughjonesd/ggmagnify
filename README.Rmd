...
Use `corners` to give a proportional radius for rounded
corners.
...
Use a [grid grob object](https://stat.ethz.ch/R-manual/R-devel/library/grid/html/grid.grob.html) or data frame to magnify any shape:
...
For complex modifications to the inset, use the `plot` argument to
set the plot explicitly. Use `inset_theme()`
